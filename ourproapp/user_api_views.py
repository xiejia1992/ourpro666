...
from utils import create_token, check_user_login, check_token, check_user_exists, check_register_code, create_user_id
    ...
    if check_register_code(user, identifying_code):
        if "@" in user:
            user = User.objects.create(
                ...
                user_image='user_image_default.png',
                user_mobile='',
                user_email=user,
